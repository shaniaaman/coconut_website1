...
class SeatClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat_class" do
    assert_difference('SeatClass.count') do
      post seat_classes_url, params: { seat_class: { class_name: @seat_class.class_name, food_services: @seat_class.food_services, leg_room: @seat_class.leg_room, price: @seat_class.price, seat_type: @seat_class.seat_type } }
    end
  ...
  test "should update seat_class" do
    patch seat_class_url(@seat_class), params: { seat_class: { class_name: @seat_class.class_name, food_services: @seat_class.food_services, leg_room: @seat_class.leg_room, price: @seat_class.price, seat_type: @seat_class.seat_type } }
